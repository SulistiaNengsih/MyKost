<!-- Edit Kategori -->
<div class="modal fade" id="editKategori2" tabindex="-1" aria-labelledby="editKategoriLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <input type="hidden" id="jenisUpdate" name="jenisUpdate" value="Pemasukan">
