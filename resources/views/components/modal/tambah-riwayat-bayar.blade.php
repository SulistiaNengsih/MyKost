...
<div class="modal fade" id="tambahRiwayatBayar" tabindex="-1" aria-labelledby="tambahRiwayatBayarLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="/tambah-riwayat-bayar" method="post" enctype="multipart/form-data">
          @csrf
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="tambahRiwayatBayarLabel">Tambah Riwayat Pembayaran</h1>
